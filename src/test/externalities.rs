...
impl<Runtime: frame_system::Trait> TestExternalities<Runtime> {
    pub fn new(client: rpc::StateClient<Runtime>) -> Self {
        Self { client, extensions: Extensions::new() }
    }
...
impl<Runtime: frame_system::Trait> sp_externalities::Externalities for TestExternalities<Runtime> {
	...
	fn storage_hash(&self, _key: &[u8]) -> Option<Vec<u8>> { unimplemented!("storage_hash") }

	fn child_storage_hash(
		&self,
		_child_info: &ChildInfo,
		_key: &[u8],
	) -> Option<Vec<u8>> { unimplemented!("child_storage_hash") }

	fn child_storage(
		&self,
		_child_info: &ChildInfo,
		_key: &[u8],
	) -> Option<Vec<u8>> { unimplemented!("child_storage") }

	fn next_storage_key(&self, _key: &[u8]) -> Option<Vec<u8>> { unimplemented!("next_storage_key") }

	fn next_child_storage_key(
		&self,
		_child_info: &ChildInfo,
		_key: &[u8],
	) -> Option<Vec<u8>> { unimplemented!("next_child_storage_key") }

	fn kill_child_storage(&mut self, _child_info: &ChildInfo) { unimplemented!("kill_child_storage") }

	fn clear_prefix(&mut self, _prefix: &[u8]) { unimplemented!("clear_prefix") }
	...
	fn chain_id(&self) -> u64 { unimplemented!("chain_id") }

	fn storage_root(&mut self) -> Vec<u8> { unimplemented!("storage_root") }

	fn child_storage_root(
		&mut self,
		_child_info: &ChildInfo,
	) -> Vec<u8> { unimplemented!("child_storage_root") }
	...
	fn wipe(&mut self) { unimplemented!("wipe") }

	fn commit(&mut self) { unimplemented!("commit") }
